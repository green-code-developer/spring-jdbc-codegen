...
public class BaseHelperGenerator {
    ...
    public String generateBaseHelper() {
        ...
        sb.add("    }");
        sb.add("");
        sb.add("    public static String escapeLike(String s) {");
        sb.add("        return escapeLike(s, '\\\\');");
        sb.add("    }");
        sb.add("");
        sb.add("    public static String escapeLike(String s, char escapeChar) {");
        sb.add("        if (escapeChar == '%' || escapeChar == '_') {");
        sb.add("            throw new IllegalArgumentException(\"エスケープ文字にワイルドカードは指定できません: \" + escapeChar);");
        sb.add("        }");
        sb.add("        String e = String.valueOf(escapeChar);");
        sb.add("        // エスケープ文字自身を先に置換しないと、後続の置換で二重にエスケープされる");
        sb.add("        return s.replace(e, e + e)");
        sb.add("                .replace(\"%\", e + \"%\")");
        sb.add("                .replace(\"_\", e + \"_\");");
        sb.add("    }");
        sb.add("}");
        sb.add("");
        return join("\n", sb);
