...
public abstract class TestBaseAllTypesAsPkRepository {

    protected void test(BaseAllTypesAsPkRepository repository) {
        var seed = 1;
    ...
    public AllTypesAsPkEntity generateTestData(int seed) {
        var entity = new AllTypesAsPkEntity();
