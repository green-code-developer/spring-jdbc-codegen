...
public abstract class TestBaseNowPk3Repository {

    protected void test(BaseNowPk3Repository repository) {
        var seed = 1;
        ...
        assert4colNow(data.getColNow(), stored.getColNow());
        ...
        assert4colNow(data2.getColNow(), stored2.getColNow());
    ...
    public NowPk3Entity generateTestData(int seed) {
        var entity = new NowPk3Entity();
