...
public abstract class TestBaseOmittablePk3Repository {

    protected void test(BaseOmittablePk3Repository repository) {
        var seed = 1;
    ...
    public OmittablePk3Entity generateTestData(int seed) {
        var entity = new OmittablePk3Entity();
