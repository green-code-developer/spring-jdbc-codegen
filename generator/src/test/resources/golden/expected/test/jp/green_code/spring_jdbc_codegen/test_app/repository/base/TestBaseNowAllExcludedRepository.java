...
public abstract class TestBaseNowAllExcludedRepository {

    protected void test(BaseNowAllExcludedRepository repository) {
        var seed = 1;
    ...
    public NowAllExcludedEntity generateTestData(int seed) {
        var entity = new NowAllExcludedEntity();
