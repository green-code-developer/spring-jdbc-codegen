...
public abstract class TestBaseNowPk1Repository {

    protected void test(BaseNowPk1Repository repository) {
        var seed = 1;
    ...
    public NowPk1Entity generateTestData(int seed) {
        var entity = new NowPk1Entity();
