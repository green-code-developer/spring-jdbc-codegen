...
public class ColumnDefinition extends BaseColumnDefinition {
    public ColumnDefinition(String columnName, String javaPropertyName, String javaFqcn, String dbTypeName, Integer jdbcType, Integer columnSize, @Nullable Integer primaryKeySeq, boolean nullable, boolean hasDefault, @Nullable String dbParamTemplate, @Nullable String dbSelectTemplate, boolean isReturning, boolean hasNameMapping) {
        super(columnName, javaPropertyName, javaFqcn, dbTypeName, jdbcType, columnSize, primaryKeySeq, nullable, hasDefault, dbParamTemplate, dbSelectTemplate, isReturning, hasNameMapping);
    }
}