CREATE SCHEMA dbcodegen AUTHORIZATION dbcodegen;
ALTER ROLE dbcodegen SET search_path = dbcodegen;
GRANT ALL ON SCHEMA dbcodegen TO dbcodegen;
SET search_path TO dbcodegen;
